...
```eos
!
username arista privilege 15 role network-admin secret sha512 $6$vjJxJmmdWdeDEL65$fJ6DmprCuvqB3.TJIfI3d8IzkoUTnSo51.5NBgqRtZxpr9m/eJazOG5VehGwmbRresmFlwUGBcIIlX5d7afNN/
```
