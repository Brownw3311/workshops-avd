...
```eos
!
username arista privilege 15 role network-admin secret sha512 $6$2eEyx/cC7UomCKOd$fkJwDOOkMYPZnN49ZpqtKSwHvlnGTjwrt7PomADudreLVnGmChIRb6K4kJ74wESs7XVPT09noJa/lyFvYbXz//
```
