...
```eos
!
username arista privilege 15 role network-admin secret sha512 $6$SiZOJMevKcMX8s.R$laY0yExoWj.mVlVm2Ttclt5RSLtYIFJvDAUu4NroNSossLMuQx/XKJcFewGBkZg4kCknc2yyB80BoyPheotX.0
```
