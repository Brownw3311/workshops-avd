...
```eos
!
username arista privilege 15 role network-admin secret sha512 $6$/ZqEt1LCKxmu9Rqa$T5oEjWM4liKwm64sNeezOYxPK3aQkkVcE2FOx.RSdlRNpLMnBMHj.IdpDNcWbOh/UwRCcxeiDs2x48Ke6fGze.
```
